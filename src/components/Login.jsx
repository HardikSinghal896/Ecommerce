    ...
    <>
      <div className={style.mainContainer}>
        ...
        <div className={style.rightContainer}>
          ...
          <h1 className={style.header}>Enter Email Address</h1>
          <p className={style.para}>We will send an sms with 5-digit verification code on this number</p>
          <input type="email" placeholder='9999 999 999' onChange={(e) =>{
            setData((prev) => {
              return{
          ...
          <button className={style.OTPbutton} onClick={handleLogin}>Get OTP</button>
        </div>
      </div>
    </>
  )
